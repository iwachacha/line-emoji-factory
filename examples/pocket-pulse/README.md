...
This repository is dedicated to production, QA, review, and release work for the LINE emoji / sticker brand `Pocket Pulse`.
...
python ./tools/validate-assets.py "<this-repo-path>/releases/release-001/submission/line-upload/images" --expected-count 8 --stage submission
```
