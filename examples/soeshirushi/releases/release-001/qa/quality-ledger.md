...
- ID: `SOE-Q-001`
  ...
  - 直す owner file: `brand/brand-production-brief.md`, `releases/release-001/production-handoff.md`
...
- ID: `SOE-Q-002`
  ...
  - 直す owner file: `releases/release-001/release-spec.md`, `releases/release-001/production-handoff.md`
  - factory昇格候補: まだなし
...
- ID: `SOE-Q-003`
  ...
  - 直す owner file: `brand/brand-setting.md`, `releases/release-001/release-spec.md`
...
- ID: `SOE-Q-005`
  ...
  - 直す owner file: `releases/release-001/release-spec.md`, `releases/release-001/qa/usage-validation.md`
...
- ID: `SOE-C-001`
  ...
  - 更新した owner file: `workflows/brand-lifecycle-workflow.md`, `templates/repo/brand-repo-blueprint.md`, `templates/repo/brand-repo-manifest-template.yaml`, `tools/init-brand-repo.ps1`
  - いつ閉じたか: `2026-04-23`
- ID: `SOE-C-002`
  - 何を直したか: 初期 release を `8` から `16` へ拡張し、release 固有コンセプトと主力 / 補助枠を定義した
  - 更新した owner file: `brand/brand-production-brief.md`, `releases/release-001/release-spec.md`, `releases/release-001/production-handoff.md`
  - いつ閉じたか: `2026-04-23`
...
- `templates/brand/brand-production-brief-template.md` 更新候補: なし
- `templates/release/production-handoff-template.md` 更新候補: なし
- `skills/` 更新候補: 現時点では追加なし
- `tools/init-brand-repo.ps1` 更新候補: usage validation / retrospective scaffold は反映済み
...
## 7. Linked Evidence
- usage validation: `releases/release-001/qa/usage-validation.md`
- retrospective: `releases/release-001/qa/release-retrospective.md`
