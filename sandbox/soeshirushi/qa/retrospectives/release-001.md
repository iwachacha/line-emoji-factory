...
- milestone: `design`
- 日付: `2026-04-24`
- 参照した evidence: `emoji-sets/releases/release-001.md`, `production/handoffs/release-001-handoff.md`, `qa/quality-ledger.md`, `qa/usage-validations/release-001.md`, `submissions/release-log.md`
...
- 壊れたレイヤー: `商品`
- 次の修正先: `qa/usage-validations/release-001.md`, `emoji-sets/releases/release-001.md`, `production/handoffs/release-001-handoff.md`
