...
- [x] 単体送信でも文中使用でも死んでいない

## Gate 2: rough / handoff
- [x] rough board が set 全体の方向を説明できる
...
- [x] 代替される既存表現より、絵文字を使う意味が残っている
- [x] 負け筋を quality ledger へ反映した

## Gate 3: 完成データ
- [x] 公式サイズ、形式、透過、容量制約を満たす
- [x] 小表示で主要要素が潰れない
- [x] アニメーション使用時は 1 フレーム目で意味が読める
- [x] 似た差分や色違い水増しがない
- [x] タブ画像とセット本体が整合している

## Gate 4: metadata / review
- [x] タイトル、説明文、コピーライトが仕様に収まる
- [x] metadata と絵文字内容が一致している
- [x] Hard NG リスクがない
- [x] Revise 項目を放置していない
...
## Final QA Note
- Status: `pre-submission ready`
- Remaining blocker: none
- Manual action still required: LINE Creators Market へのログイン、画像ZIPとmetadataの登録、審査提出。
