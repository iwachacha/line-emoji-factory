...
## 使う正本
- 品質論点: `templates/quality-ledger-template.md`
- 具体会話検証: `templates/usage-validation-template.md`
- 履歴: `templates/release-log-template.md`
- 継続改善: `workflows/continuous-improvement-workflow.md`
- 出力枠: `templates/release-retrospective-template.md`
