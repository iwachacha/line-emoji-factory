...
This repository is dedicated to production, QA, review, and release work for the LINE emoji brand `ゆるゲージ`.

## Entry Points
- Market research: `references/market/idea-batch-001.md`
...
- Trial report: `reports/end-to-end-trial-report.md`
