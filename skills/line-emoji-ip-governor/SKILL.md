...
description: 固定IP、企業キャラクター、コラボIPをLINE絵文字 / スタンプとして扱うときに、許諾範囲、参照素材、禁止表現、承認ログを統制する入口。
---

# LINE絵文字 / スタンプ IP governor
...
8. LINE item としての使用場面は、必ず `構造 → ブランド → 商品` で判定する。

## Output Rules

- `許諾範囲 / 使用可能素材 / 禁止事項 / IPらしさ / LINE item 使用場面 / 承認状態 / 次アクション` を出す。
