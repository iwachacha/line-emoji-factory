...
16. ブランド repo 分離なら `../../workflows/brand-lifecycle-workflow.md`, `../../templates/repo/brand-repo-blueprint.md`, `../../tools/init-brand-repo.ps1` を使う。標準は startup repo であり、実画像制作へ入る場合だけ production skeleton を使う。
