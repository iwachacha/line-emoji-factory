...
このテンプレートは、factory 共通で再利用したい学習だけを残す。
長文化より、次回判断に効く密度を優先する。
...
- Observation:
- Affected layer: `構造 / ブランド / 固定IP / 商品 / 品質 / 制作パイプライン / 販売直前パッケージ / scaffold / 市場探索 / skill / 文書`
- Evidence:
...
- What improved:
- Updated owner file:
- Promoted to: `brand / factory / skill`
- Verified by:
- Closed on:
...
- New skill needed:
- Why workflow / template only では足りないか:
- Next check:
